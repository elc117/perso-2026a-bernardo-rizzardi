...
/* package rpg-engine-0.1.0.0 */
#ifndef VERSION_rpg_engine
#define VERSION_rpg_engine "0.1.0.0"
#endif /* VERSION_rpg_engine */
#ifndef MIN_VERSION_rpg_engine
#define MIN_VERSION_rpg_engine(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_rpg_engine */
...
#define CURRENT_COMPONENT_ID "rpg-engine-0.1.0.0-3uYpewaPNoiE6ayqLVB6hn-rpg-tests"
